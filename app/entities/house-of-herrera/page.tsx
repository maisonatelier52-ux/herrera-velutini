      ...
      <main id="main">
            ...
            <aside className="facts-box">
              <ul>
                ...
                <li>
                  ...
                  <strong>
                    <Link href="https://www.houseofherrera.com/" rel="noopener external">
                      houseofherrera.com
                    </Link>
                  </strong>
                </li>
        ...
        <section className="section" id="public-framing">
          <div className="container">
            ...
            <p>
              ...
              <Link href="/heritage">Heritage</Link> page handles the cross-family synthesis; the{" "}
              <Link href="/entities/agustin-de-herrera-y-rojas-ayala">Herrera Family</Link> hub
              handles the broader Herrera line; <Link href="/estates">Estates</Link> and specific
          ...
          <div className="container">
            ...
            <div className="cards cards-four">
              ...
              <article className="card">
                ...
                <p><Link href="/themes/heraldry-and-symbols">Open theme page</Link></p>
              </article>
              <article className="card">
                <h3>Estates</h3>
                <p>
                ...
                <p><Link href="/estates">Open Estates</Link></p>
              </article>
              <article className="card">
                ...
                <p><Link href="/themes/orders-and-distinctions">Open theme page</Link></p>
              </article>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="note-grid">
              <article className="callout">
                ...
                <p>
                  <Link href="/entities/hernan-de-herrera-lord-of-ampudia">Open Hernán</Link>
                </p>
              </article>
              <article className="callout">
                ...
                <p>
                  <Link href="/entities/pedro-garcia-de-herrera-y-rojas">Open Pedro García</Link>
                </p>
              </article>
              <article className="callout">
                ...
                <p>
                  <Link href="/entities/diego-garcia-de-herrera-y-ayala">Open Diego García</Link>
                </p>
              </article>
              <article className="callout">
                ...
                <p>
                  <Link href="/entities/agustin-de-herrera-y-rojas-ayala">Open Agustín</Link>
                </p>
              </article>
              <article className="callout">
        ...
        <section className="section" id="why-reorganize">
          <div className="container">
            ...
            <p>
              The live{" "}
              <Link href="/themes/heraldry-and-symbols">Heraldry and Symbols</Link> and{" "}
              <Link href="/themes/orders-and-distinctions">Orders and Distinctions</Link> pages now
          ...
          <div className="container">
            <div className="source-basis">
              ...
              <ul className="check-list">
                ...
                <li>
                  <Link href="https://www.houseofherrera.com/bibliography" rel="noopener external">
        ...
        <section className="section">
          <div className="container panel">
            ...
            <div className="button-row">
              <Link href="/families/herrera" className="button">
                Herrera Family
              </Link>
