            ...
            <aside className="facts-box">
              <ul>
                ...
                <li>
                  ...
                  <strong><Link href="/families/herrera-velutini-connection/" title="Herrera and Velutini">Herrera and Velutini</Link></strong>
                </li>
              </ul>
            </aside>
          </div>
          ...
          <div className="container">
            ...
            <div className="cards cards-four">
              <article className="card">
                ...
                <p><Link href="/entities/hacienda-de-la-vega/" title="Open Hacienda de La Vega">Open Hacienda de La Vega</Link></p>
              </article>
              <article className="card">
                <h3>Banco Caracas</h3>
                <p>
                ...
                <p><Link href="/entities/banco-caracas/" title="Open Banco Caracas">Open Banco Caracas</Link></p>
              </article>
              <article className="card">
                <h3>Clementina</h3>
                <p>
                ...
                <p><Link href="/entities/clementina-velutini-perez-matos/" title="Open Clementina">Open Clementina</Link></p>
              </article>
              <article className="card">
                <h3>Belén Clarisa</h3>
                <p>
          ...
          <div className="container">
            <div className="source-basis">
              ...
              <ul className="check-list">
                <li>
                  <Link href="https://www.houseofherrera.com/family-estates" rel="noopener external" title="House of Herrera — Family Estates">House of Herrera — Family Estates</Link> — Used for the Hacienda de La Vega narrative, its Caracas-Valley setting, the 1899 acquisition note involving the late Banco de Caracas, and the estate&apos;s public-landmark status.
                </li>
                <li>
                ...
                <li>
                  <Link href="https://books.google.com/books/about/Los_amos_del_valle.html?id=7KkNAAAAIAAJ" rel="noopener external" title="Google Books — Los amos del valle">Google Books — Los amos del valle</Link> — Used for bibliography metadata around Francisco J. Herrera Luque&apos;s Caracas-Valley contextual work; not treated here as a standalone factual authority.
                </li>
                <li>
                  <Link href="https://books.google.com/books/about/La_Vega.html?id=MXtdAAAAMAAJ" rel="noopener external" title="Google Books — La Vega: A Colonial Casa">Google Books — La Vega: A Colonial Casa</Link> — Used for bibliography metadata around the Hacienda de La Vega estate-context lead; not treated here as a standalone factual authority.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="section">
          <div className="container panel">
            ...
            <div className="button-row">
              <Link className="button" href="/entities/banco-caracas/" title="Banco Caracas">Banco Caracas</Link>
              <Link className="button-secondary" href="/entities/hacienda-de-la-vega/" title="Hacienda de La Vega">Hacienda de La Vega</Link>
