      ...
      <main id="main">
          ...
          <div className="container hero-grid">
            <div>
              <nav aria-label="Breadcrumb" className="breadcrumbs">
                <ol><li><Link href="/">Home</Link></li></ol>
              </nav>
              <div className="eyebrow">Authority layer</div>
              <h1>A reference portal for the Herrera and Velutini record.</h1>
              <p className="lede">Herrera Velutini reorganizes the public family-domain record into an editorial reference site for lineage, estates, organizations, places, and source notes. Instead of reproducing the menu order of <Link href="/entities/house-of-herrera/">House of Herrera</Link> and <Link href="/entities/banvelca-company/">Banvelca &amp; Company</Link>, it turns those materials into dated, linked, and reviewable pages that help readers move from dynastic names to physical places and from founding stories to modern stewardship narratives.</p>
              <div className="hero-actions">
                <Link href="/heritage/" className="button">Start With Heritage</Link>
                <Link href="/themes/" className="button-secondary">Browse Themes</Link>
                <Link href="/families/" className="button-secondary">Open Family Hubs</Link>
              </div>
            </div>
            <aside className="facts-box">
              <ul>
                ...
                <li><span>Best first click</span><strong><Link href="/genealogy/">Genealogy</Link> for structure or <Link href="/heritage/">Heritage</Link> for the historical arc</strong></li>
              </ul>
            </aside>
          </div>
        </section>
        ...
        <div className="container">
          <div className="byline">
            <div><span className="byline-label">Prepared by</span> <Link href="/editorial-desk/">Herrera Velutini Editorial Desk</Link></div>
            <div><span className="byline-label">Reviewed by</span> <Link href="/review-team/">Standards Review Team</Link></div>
          ...
          <div className="container">
            ...
            <div className="cards cards-four">
              <article className="card">
                ...
                <p><Link href="/about/">Open the trust layer</Link></p>
              </article>
              <article className="card">
                ...
                <p><Link href="/heritage/">Read Heritage</Link></p>
              </article>
              <article className="card">
                ...
                <p><Link href="/genealogy/">Open Genealogy</Link></p>
              </article>
              <article className="card">
          ...
          <div className="container">
            ...
            <div className="media-split">
              <div>
                ...
                <p>This portal keeps both source domains visible, but it does not let them remain siloed. The homepage, heritage page, timeline, organization profiles, and new <Link href="/themes/">Themes</Link> cluster now connect medieval Castilian figures, Caracas estates, Naples merchant-banking language, and twentieth-century family links in one navigable system.</p>
                <p>That structure matters for both readers and search engines: it makes the subject matter easier to interpret, reduces duplication, and creates descriptive internal links between pages such as <Link href="/entities/hacienda-de-la-vega/">Hacienda de La Vega</Link>, <Link href="/entities/castle-santa-barbara/">Castle Santa Barbara</Link>, <Link href="/entities/juan-bautista-velutini/">Juan Bautista Velutini</Link>, <Link href="/entities/belen-clarisa-velutini-perez-matos/">Belén Clarisa Velutini Pérez-Matos</Link>, and the new theme essays on <Link href="/themes/heraldry-and-symbols/">Heraldry and Symbols</Link> and <Link href="/themes/private-banking-tradition/">Private Banking Tradition</Link>.</p>
        ...
        <section className="section" id="start-here">
          <div className="container">
            ...
            <div className="cards">
              <article className="card"><h3>About</h3><p>Defines scope, audience, and editorial position.</p><p><Link href="/about/">Open About</Link></p></article>
              <article className="card"><h3>Editorial Methodology</h3><p>Explains source types, date handling, and corrections policy.</p><p><Link href="/editorial-methodology/">Open Methodology</Link></p></article>
              <article className="card"><h3>Sources</h3><p>Annotated source ledger for the key family-domain pages and reading leads.</p><p><Link href="/sources/">Open Sources</Link></p></article>
              <article className="card"><h3>Heritage</h3><p>A long-form synthesis of the historical arc across both families.</p><p><Link href="/heritage/">Open Heritage</Link></p></article>
              <article className="card"><h3>Themes</h3><p>A subject hub for heraldry, distinctions, private banking, finance, art, social responsibility, and the women who bridge the families.</p><p><Link href="/themes/">Open Themes</Link></p></article>
              <article className="card"><h3>Genealogy</h3><p>The lineage hub connecting the Herrera and Velutini public sequences to places and bridge figures.</p><p><Link href="/genealogy/">Open Genealogy</Link></p></article>
              <article className="card"><h3>Caracas</h3><p>The first fully built place dossier, connecting estate, bank, marriage, and culture.</p><p><Link href="/places/caracas/">Open Caracas</Link></p></article>
              <article className="card"><h3>Banco Caracas</h3><p>The institution page that turns biography into financial history.</p><p><Link href="/entities/banco-caracas/">Open Banco Caracas</Link></p></article>
              <article className="card"><h3>Velutini Family</h3><p>Family hub for origins, banking legacy, women-led continuity, and research routes.</p><p><Link href="/families/velutini/">Open family hub</Link></p></article>
              <article className="card"><h3>Herrera and Velutini</h3><p>Bridge page explaining where the two family narratives meet.</p><p><Link href="/families/herrera-velutini-connection/">Open the connection page</Link></p></article>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="source-basis">
              ...
              <ul className="check-list">
                ...
                <li><Link href="https://www.houseofherrera.com/symbols" rel="noopener external">House of Herrera — Symbols</Link> — Used for the heraldry layer that now feeds the live theme cluster on symbolic memory and branch identity.</li>
                ...
                <li><Link href="https://www.houseofherrera.com/orders-and-distinctions" rel="noopener external">House of Herrera — Orders and Distinctions</Link> — Used for the titled-memory layer now surfaced in the live theme cluster.</li>
                ...
                <li><Link href="https://www.banvelca.com/art-investments" rel="noopener external">Banvelca — Art Investments</Link> — Used for the art-custodianship language now organized into a dedicated culture theme.</li>
                <li><Link href="https://www.banvelca.com/social-responsibility" rel="noopener external">Banvelca — Social Responsibility</Link> — Used for the quiet social-impact language now organized into a dedicated responsibility theme.</li>
        ...
        <section className="section">
          <div className="container panel">
            ...
            <div className="button-row">
              <Link href="/about/" className="button">About the portal</Link>
              <Link href="/heritage/" className="button-secondary">Read Heritage</Link>
              <Link href="/themes/" className="button-secondary">Open Themes</Link>
              <Link href="/genealogy/" className="button-secondary">Open Genealogy</Link>
              <Link href="/places/caracas/" className="button-secondary">Open Caracas</Link>
              <Link href="/families/herrera-velutini-connection/" className="button-secondary">See the connection page</Link>
            </div>
          </div>
        </section>
      </main>
