          ...
          <div className="container">
            <div className="source-basis">
              ...
              <ul className="check-list">
                ...
                <li><Link href="https://www.banvelca.com/" rel="noopener external" title="Banvelca — Legacy">Banvelca — Legacy</Link> — Used for the chronological ancestor timeline spanning Juan Bautista through later generations, including Banco Caracas, Clementina, Belén Clarisa, Julio José, and later generations.</li>
                ...
                <li><Link href="https://www.banvelca.com/" rel="noopener external" title="Banvelca — Art Investments">Banvelca — Art Investments</Link> — Used for the art-custodianship language now organized into a dedicated culture theme.</li>
                <li><Link href="https://www.banvelca.com/" rel="noopener external" title="Banvelca — Social Responsibility">Banvelca — Social Responsibility</Link> — Used for the quiet social-impact language now organized into a dedicated responsibility theme.</li>
